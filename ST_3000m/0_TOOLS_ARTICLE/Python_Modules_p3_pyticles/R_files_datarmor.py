...
###################################################################################
    def __init__(self,simulname=None,time=None, floattype=np.float,**kwargs):
        ...
        if self.ncname.model in ['ucla','croco']:
            ...
            date = self.ncname.realyear_tstart + timedelta(seconds=time1*self.ncname.dtfile)
            year1 = date.year
            month1 = date.month
            day1 = date.day
            
            time2 = time1 + self.ncname.tfile #- 1
            date = self.ncname.realyear_tstart + timedelta(seconds=time2*self.ncname.dtfile) -timedelta(days=1)
            year2 = date.year
            month2 = date.month
            day2 = date.day
...
###################################################################################
    ...
    def __init__(self, simul, time=0):
        ...
        krypton='/net/data0-gw/data0/project/meddle/'
        ...
        #ncra atlbig_dhis.00[7-9]* atlbig_dhis.0[1-2]* atlbig_dhis.mean2.nc
            ...
            folder='/net/data0-gw/data0/project/meddle/gula/ROMS/Simulations'
...
#temporary################################################################
        ...
        ##################
            ...
            folder= '/net/data0-gw/data0/project/meddle/gula/ROMS/Simulations/GS/'
        ...
        ##################
            ...
            if os.getenv('HOSTNAME') is None:
                if 'mean' in simul:
                    folder= '/net/data0-gw/data0/project/meddle/lecorre/POLGYR_NATL/'
        ...
        ##################
            ...
            if os.getenv('HOSTNAME') is None:
                folder= '/net/data0-gw/data0/project/meddle/lecorre/POLGYR/AVG'
                self.his=folder + '/polgyr_his.'
                self.grd='/net/data0-gw/data0/project/meddle/lhoupert/polgyr_grd.nc'
            else:
        ...
        ################## Test case (to test online features)
          ...
          ################## AGULHAS TEST CASE
            ...
            self.model = 'agrif_jc'
            folder=  '/net/data0-gw/data0/project/vortex/Master_stage_tedesco2017/SCRATCH_RUN_WOES5/'
            self.his=folder + '/roms_avg_'
        ...
        ##################
            ...
            if 'surf_avg' in simul:
                ...
                if 'sig' in simul:
                    self.his='/net/data0-gw/data0/project/meddle/gula/ROMS/Simulations/CHABAM/iso/chabam_sig_uv.'
                    self.digits = 4
                else:
        ...
        ######
            ...
            if 'surf_avg' in simul:
                ...
                if 'sig' in simul:
                    self.his='/net/data0-gw/data0/project/meddle/gula/ROMS/Simulations/CHABAH/iso/chabah_sig_uv.'
                    self.digits = 4
                else:
        ...
        ######
            ...
            if 'surf_avg' in simul:
                ...
                if 'sig' in simul:
                    self.his='/net/data0-gw/data0/project/meddle/gula/ROMS/Simulations/CHABAT/iso/chabat_sig_uv.'
                    self.digits = 4
                else:
        ...
        ##################
            ...
            self.model = 'croco'
            self.digits = 4
            folder= '/net/data0-gw/data0/project/meddle/cvic/ROMS/Simulations/RIDGE/'
        ...
        ##################
            ...
            self.model = 'croco'
            self.digits = 4
            folder ='/net/data0-gw/data0/project/nhmg/ducousso/CROCO-NH/NBIMIN/INPUT/' 
 
            self.grd=folder + 'nbimin_grd.nc'  
            self.frc=folder + 'nbimin_frc.nc'
            self.wind=folder + 'nbimin_frc.nc'

            folder= '/net/data0-gw/data0/project/nhmg/ducousso/CROCO-NH/NBIMIN2/EXP_H_dt3_nft50_OBC2DSPEC3DSPEC_SPGnuintwidthnam_5d/'
        ...
        ##################
            ...
            folder= '/net/data0-gw/data0/project/nhmg/ducousso/CROCO-NH/NBIMIN2/EXP_NHMG_dt3_nft50_OBC2DSPEC3DSPEC_SPGnuintwidthnam_5d/'
        ...
        ##################
            ...
            if 'mean' in simul:
                self.his= '/net/data0-gw/data0/project/nhmg/gula/biminh_his.mean'
                self.digits = 0
            elif 'sig' in simul:
        ...
        ##################
            ...
            if 'mean' in simul:
                self.his= '/net/data0-gw/data0/project/nhmg/gula/biminnh_his.mean'
                self.digits = 0
            elif 'sig' in simul:
        ...
        ##################
            ...
            try:
                ...
                folder= '/net/data0-gw/data0/project/meddle/gula/ROMS/Simulations/SISMO/'
      ...
      ##################        
            ...
            self.grd= '/ccc/store/cont003/gen7638/gulaj/gigatl3_grd.nc'


            folder = '/ccc/scratch/cont003/gen7638/gulaj/GIGATL3/GIGATL3_dev_tides_xios/HIS_v2/'
            if 'surf' in simul:
                self.his = folder + 'MEGATL3_1h_00230125_00290527_inst_surf_0001-01-01-0001-01-05.nc'
            else:
                self.his=folder + 'MEGATL3_12h_00230125_00290527_inst'
        ...
        ##################        
            ...
            folder_name= 'GIGATL3_dev_rivers_bhf_xios/'

            try:
                if 'curie' in os.getenv('HOSTNAME') or 'irene' in os.getenv('HOSTNAME'):
                    #folder='/ccc/store/cont003/gen7638/gulaj/' + folder_name
                    folder = '/ccc/scratch/cont003/gen7638/gulaj/GIGATL3/' + folder_name + 'HIS/'
                    self.grd= '/ccc/store/cont003/gen7638/gulaj/gigatl3_grd.nc'
            except:
       ...
       ##################        
            ...
            if 'ratlbig_GLS_devweek_M3FAST_bulk' in simul:
                ...
                folder_name= 'GIGATL6_6h/HIS/'
            elif 'gigatl6_1h' in simul:
                folder_name= 'GIGATL6_1h/HIS/'
            else:
                folder_name= 'GIGATL6/'
            ...
            try:
                if 'curie' in os.getenv('HOSTNAME') or 'irene' in os.getenv('HOSTNAME'):
                    #folder='/ccc/store/cont003/gen7638/gulaj/' + folder_name
                    folder = '/ccc/scratch/cont003/gen7638/gulaj/GIGATL6/' + folder_name + 'HIS/'
                    self.grd= '/ccc/store/cont003/gen7638/gulaj/GIGATL6/gigatl6_grd.nc'
                else: # 'datarmor' in os.getenv('HOSTNAME'):
                    folder= '/home2/datawork/jgula/Simulations/GIGATL6/' + folder_name
                    self.grd= '/home2/scratch/jgula/megatl/GIGATL6/gigatl6_grd.nc'
            except:
