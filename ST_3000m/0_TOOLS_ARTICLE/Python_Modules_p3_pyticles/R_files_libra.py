...
###################################################################################
    ...
    def oceandate(self):
        ...
        #Doesn't work because ROMS uses 360 days 
        ncfile.close()
...
#temporary################################################################
        ...
        ##################
            ...
            self.model = 'croco'
            self.digits = 5
            folder= '/net/krypton/data0/project/meddle/lecorre/POLGYR/POLGYR_his/'
            self.his=folder + '/HIS/polgyr_his.'
            self.grd=libra +'/gula/ROMS/Simulations/POLGYR/polgyr_grd.nc'
        ...
        ##################
            ...
            '''
            folder=cherokee +'/gula/ROMS/Simulations/'
            self.his=cherokee +'/gula/ROMS/Simulations/NATL/natlc_avg.mean.'
            self.grd=folder + '/NATL/natl6_grd_agrifV2.nc'
            self.frc=folder + 'natl6_frc.nc'
            self.wind=folder + 'natl6_frc.nc'
            self.tfile=1
        ...
        ##################
            ...
            '''
            folder=cherokee +'/gula/ROMS/Simulations/'
            self.his=cherokee +'/gula/ROMS/Simulations/NATL/natlu_avg.mean.'
            self.grd=folder + '/NATL/natl6_grd_agrifV2.nc'
            self.frc=folder + 'natl6_frc.nc'
            self.wind=folder + 'natl6_frc.nc'
            self.tfile=1
        ...
        ##################
            ...
            '''
            folder=cherokee +'/gula/ROMS/Simulations/'
            self.his=cherokee +'/gula/ROMS/Simulations/NATL/natluz_avg.mean.'
            self.grd=folder + '/NATL/natl6_grd_agrifV2.nc'
            self.frc=folder + 'natl6_frc.nc'
            self.wind=folder + 'natl6_frc.nc'
            self.tfile=1
        ...
        ##################
            ...
            '''
            folder=cherokee +'/gula/ROMS/Simulations/'
            self.his=cherokee +'/gula/ROMS/Simulations/NATL/natlcz_avg.mean.'
            self.grd=folder + '/NATL/natl6_grd_agrifV2.nc'
            self.frc=folder + 'natl6_frc.nc'
            self.wind=folder + 'natl6_frc.nc'
            self.tfile=1
        ...
        ################## Test case (to test online features)
            ...
            if '1h' in simul:
                if 'withdiag' in simul:
                    folder = ROMSSIMSK + '/NESEA/HIS1h_withdiags'
                else:
                    folder = ROMSSIMSK + '/NESEA/HIS1h'
            else:
                folder = ROMSSIMSK + '/NESEA/HIS6h'
            ...
            folder = libra + '/gula/ROMS/Simulations/NESED/HIS'


            self.grd=folder + '/../../NESEA/nesea_grd.nc'
            self.frc=folder + '/../../NESEA/nesea_frc.nc'
            self.wind=self.frc
            self.tfile=20
            self.tstart=0
            self.tend=2000
            ...
            if 'vrt' in simul:
                self.his = folder + '/nesed_diags_vrt.'
            elif 'ek' in simul:
                self.his = folder + '/nesed_diags_ek.'
            elif 'uv' in simul:
                self.his = folder + '/nesed_uv.'
            elif 'ts' in simul:
                self.his = folder + '/nesed_ts.'
            elif 'pv' in simul:
                self.his = folder + '/nesed_diags_pv.'
            else:
                self.his = folder + '/nesed_his.'
        ...
        ######
            ...
            self.frc='/ccc/scratch/cont003/gen7638/gulaj/CHABAH/chaba_frc_monthly.nc'
            self.wind=self.frc
            self.tfile=5
            self.tend=1820
        ...
        ######
            ...
            self.frc='/ccc/scratch/cont003/gen7638/gulaj/CHABAT/chaba_frc_monthly.nc'
            self.wind=self.frc
            self.tfile=5
            self.tend=1820
        ...
        ##################
            ...
            self.model = 'croco'
            self.digits = 5
            self.his=libra +'/gula/ROMS/Simulations/SARGA/HIS/sargo_his.'
            self.grd=libra +'/gula/ROMS/Simulations/SARGA/sarga_grd.nc'
            self.frc=libra +'/gula/ROMS/Simulations/SARGA/sarga_frc_all.nc'
            self.wind=libra +'/gula/ROMS/Simulations/SARGA/sarga_frc_all.nc'
            self.tfile=4
            self.tstart=0
            self.tend=10000
            ...
            self.model = 'croco'
            self.digits = 5
            self.his=libra +'/gula/ROMS/Simulations/SARGA/HIS/sarga_surf.'
            self.grd=libra +'/gula/ROMS/Simulations/SARGA/sarga_grd.nc'
            self.frc=libra +'/gula/ROMS/Simulations/SARGA/sarga_frc_all.nc'
            self.wind=libra +'/gula/ROMS/Simulations/SARGA/sarga_frc_all.nc'
            self.tfile=30
            ...
            self.model = 'croco'
            self.digits = 5
            self.his=libra +'/gula/ROMS/Simulations/SARGA/HIS/sargo_surf.'
            self.grd=libra +'/gula/ROMS/Simulations/SARGA/sarga_grd.nc'
            self.frc=libra +'/gula/ROMS/Simulations/SARGA/sarga_frc_all.nc'
            self.wind=libra +'/gula/ROMS/Simulations/SARGA/sarga_frc_all.nc'
            self.tfile=30
